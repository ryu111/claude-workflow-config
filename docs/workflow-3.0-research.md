...
| 20 | debugger | 除錯專業知識 | ⏳ | 考慮移除 |
| 21 | browser | 瀏覽器自動化 | ⏳ | 考慮移除 |
| 22 | migration | 遷移專業知識 | ⏳ | 考慮移除 |
| 23 | skill-agent | Skill/Agent 維護 | ⏳ | 考慮移除 |
| 24 | refactor | 重構專業知識 | ⏳ | 考慮移除 |
| 25 | ui | UI 視覺設計 | ⏳ | 考慮移除 |
| 26 | ux | UX 使用者體驗 | ⏳ | 考慮移除 |
| 27 | hooks-guide | Hooks 配置指南 | ⏳ | 考慮移除 |
